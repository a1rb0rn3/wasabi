...
var Wasabi = {
    ...
    resolveTableIdx: function (tableIdx) {
        ...
        let functionIdx = parseInt(Wasabi.module.table.get(tableIdx).name);

        const lowLevelHookCount = Object.keys(Wasabi.module.lowlevelHooks).length;
        if (functionIdx > lowLevelHookCount) {
            functionIdx = functionIdx - lowLevelHookCount;
        }
